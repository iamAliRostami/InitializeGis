...
public class LayerInfo {
    ...
    static final int _tileWidth = 256;
    static final int _tileHeight = 256;
    static final int _dpi = 96;
    final double X_MIN_2000 = -180.0;
    final double Y_MIN_2000 = -90.0;
    final double X_MAX_2000 = 180.0;
    final double Y_MAX_2000 = 90.0;
    final int _GCS2000 = 4490;
